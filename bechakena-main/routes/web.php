...
Route::post('/vendor_registered','App\Http\Controllers\VendorController@create_vendor')->name('vendor_register');
Route::get('/vendor_pending/{$vID}','App\Http\Controllers\VendorController@vendor_pending')->name('vendor_pending');
Route::post('/update_vendor_ID', 'App\Http\Controllers\VendorController@updateID')->name('vendor_update');
Route::get('/pending', 'App\Http\Controllers\VendorController@pending')->name('pending');
